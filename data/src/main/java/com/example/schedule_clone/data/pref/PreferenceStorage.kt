...
package com.example.schedule_clone.data.pref
...
import com.example.schedule_clone.model.Theme
import com.example.schedule_clone.data.pref.DataStorePreferenceStorage.PreferencesKeys.PREF_CODELABS_INFO_SHOWN
import com.example.schedule_clone.data.pref.DataStorePreferenceStorage.PreferencesKeys.PREF_CONFERENCE_TIME_ZONE
import com.example.schedule_clone.data.pref.DataStorePreferenceStorage.PreferencesKeys.PREF_MY_LOCATION_OPTED_IN
import com.example.schedule_clone.data.pref.DataStorePreferenceStorage.PreferencesKeys.PREF_NOTIFICATIONS_SHOWN
import com.example.schedule_clone.data.pref.DataStorePreferenceStorage.PreferencesKeys.PREF_ONBOARDING
import com.example.schedule_clone.data.pref.DataStorePreferenceStorage.PreferencesKeys.PREF_RECEIVE_NOTIFICATIONS
import com.example.schedule_clone.data.pref.DataStorePreferenceStorage.PreferencesKeys.PREF_SCHED_UI_HINTS_SHOWN
import com.example.schedule_clone.data.pref.DataStorePreferenceStorage.PreferencesKeys.PREF_SELECTED_FILTERS
import com.example.schedule_clone.data.pref.DataStorePreferenceStorage.PreferencesKeys.PREF_SELECTED_THEME
import com.example.schedule_clone.data.pref.DataStorePreferenceStorage.PreferencesKeys.PREF_SEND_USAGE_STATISTICS
import com.example.schedule_clone.data.pref.DataStorePreferenceStorage.PreferencesKeys.PREF_SNACKBAR_IS_STOPPED
